...
def train_model(train_loader, val_loader, model, tokenizer, optimizer, device, num_epochs, model_save_path, early_stopping_patience):
    ...
    for epoch in range(num_epochs):
        ...
        avg_val_loss = validate_model(val_loader, model, tokenizer, device)
...
def test_model(model, dataloader, tokenizer, device, output_file, min_length, max_length, beam_size):
    model.eval()
    results = []
...
def main():
    ...
    model_save_path = "/Users/lynn/Desktop/thesis/cnn_dm/model_save/"
    ...
    train_model(train_dataloader, valid_dataloader, model, tokenizer, optimizer, device, num_epochs, model_save_path, patience)
